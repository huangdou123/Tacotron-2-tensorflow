...
class Feeder:
  ...
  def __init__(self, coordinator, metadata_filename, hparams):
    ...
    # Load metadata
    self._mel_dir = os.path.join(os.path.dirname(metadata_filename), 'mels_1')
    self._linear_dir = os.path.join(os.path.dirname(metadata_filename), 'linear_1')

    log("**************************************************")
    log("feeder.mel_dir:{}".format(self._mel_dir))
    log("feeder.mel_dir:{}".format(self._linear_dir))
    ...
    with tf.device('/cpu:0'):
      ...
      #self.input_lengths = tf.random_uniform(
      #        shape = (1 ,hparams.tacotron_batch_size ),
      #        dtype = tf.int32,
      #        minval = 20,
      #        maxval = 40
      #        )
      ...
      #self.targets_lengths=tf.random_uniform(
      #        shape = (1 , hparams.tacotron_batch_size ),
      #        dtype = tf.int32,
      #        minval = 20, 
      #        maxval = 40
