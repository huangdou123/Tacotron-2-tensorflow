...
def main():
  ...
  parser.add_argument('--base_dir', default='/home/hp/hwx/Tacotron-2')
  parser.add_argument('--hparams', default='/home/hp/hwx/Tacotron-2',
    help='Hyperparameter overrides as a comma-separated list of name=value pairs')
  parser.add_argument('--tacotron_input', default='training_data/train.txt')
  parser.add_argument('--wavenet_input', default='/home/hp/hwx/Tacotron-2/tacotron_output/gta/map.txt')
